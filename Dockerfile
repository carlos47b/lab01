...
WORKDIR /src
COPY ["Lab01.csproj", "."]
RUN dotnet restore "./Lab01.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./Lab01.csproj" -c %BUILD_CONFIGURATION% -o /app/build

# Esta fase se usa para publicar el proyecto de servicio que se copiará en la fase final.
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./Lab01.csproj" -c %BUILD_CONFIGURATION% -o /app/publish /p:UseAppHost=false
